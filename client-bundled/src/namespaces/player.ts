 ...
 */
export function setResetFlagPreferRearSeats(player: number | string | IPlayer, vehicle: number | IVehicle): void {
    const _player = typeof player == 'object' ? player.playerId() : player;
    const _vehicle = typeof vehicle == 'object' ? vehicle.handle() : vehicle;
 ...
 */
export function setStealthSpeed(player: number | string | IPlayer, stealthSpeed: number): void {
    const _player = typeof player == 'object' ? player.playerId() : player;
 ...
 */
export function setWantedCentrePosition(player: number | string | IPlayer, pos: Vector3): void {
    const _player = typeof player == 'object' ? player.playerId() : player;
