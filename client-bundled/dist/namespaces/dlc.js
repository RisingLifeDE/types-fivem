 ...
 * No comment provided
 *
 * Hash: 0x241FCA5B1AA14F75 | Since: unknown | API-Set: unknown
 */
 ...
 * No comment provided
 *
 * Hash: 0xB42DBFF903BB270F | Since: unknown | API-Set: unknown
 */
export function areUserEntitlementsUpToDate() {
    if (!IsGameEnhancedVersion())
        console.error('This native is not supported on legacy (0xB42DBFF903BB270F)');
    return;
 ...
 * No comment provided
 *
 * Hash: 0xF3A281B1AA86DBA9 | Since: unknown | API-Set: unknown
 */
export function declareInMultiplayerThisFrame() {
    if (!IsGameEnhancedVersion())
        console.error('This native is not supported on legacy (0xF3A281B1AA86DBA9)');
    return;
 ...
 *
 * Hash: 0xF2E07819EF1A5289 | Since: unknown | API-Set: unknown
 */
 ...
 * This function is hard-coded to always return 1.
 *
 * Hash: 0xA213B11DFF526300 | Since: unknown | API-Set: unknown
 */
 ...
 * No comment provided
 *
 * Hash: 0x8D30F648014A92B5 | Since: unknown | API-Set: unknown
 */
 ...
 *
 * Hash: 0x9489659372A81585 | Since: unknown | API-Set: unknown
 */
 ...
 * No comment provided
 *
 * Hash: 0xC4637A6D03C24CC3 | Since: unknown | API-Set: unknown
 */
 ...
 * No comment provided
 *
 * Hash: 0x10D0A8F259E93EC9 | Since: unknown | API-Set: unknown
 */
 ...
 * Always returns true.
 *
 * Hash: 0x46E2B844905BC5F0 | Since: unknown | API-Set: unknown
 */
 ...
 *
 * Hash: 0x812595A0644CE1DE | Since: unknown | API-Set: unknown
 */
 ...
 *
 * Hash: 0x0888C3502DBBEEF5 | Since: unknown | API-Set: unknown
 */
 ...
 * Works in singleplayer.
 *
 * Hash: 0xD7C10C4A637992C9 | Since: unknown | API-Set: unknown
 */
 ...
 * No comment provided
 *
 * Hash: 0x140491FD99CE6F5D | Since: unknown | API-Set: unknown
 */
export function tryGetUserEntitlements() {
    if (!IsGameEnhancedVersion())
        console.error('This native is not supported on legacy (0x140491FD99CE6F5D)');
    return;
