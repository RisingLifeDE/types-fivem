 ...
 */
export declare function setDrawableLodThresholds(entity: number | IEntity, highLod: number, medLod: number, lowLod: number, vlowLod: number): void;
/**
 * No comment provided
 *
 ...
 */
export declare function getChildAttachment(entity: number | IEntity): number;
/**
 * No comment provided
 *
 ...
 */
export declare function isFixed(entity: number | IEntity): boolean;
/**
 * No comment provided
 *
