 ...
 */
export declare function setResetFlagPreferRearSeats(player: number | string | IPlayer, vehicle: number | IVehicle): void;
/**
 * No comment provided
 *
 ...
 */
export declare function setStealthSpeed(player: number | string | IPlayer, stealthSpeed: number): void;
/**
 ...
 */
export declare function setWantedCentrePosition(player: number | string | IPlayer, pos: Vector3): void;
/**
