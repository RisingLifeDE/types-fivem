 ...
 *
 * Hash: 0xD9F8455409B525E9 | Since: unknown | API-Set: unknown
 */
export declare function addShockingAtPosition(eventType: number, pos: Vector3, duration: number): number;
/**
 * eventType: https://alloc8or.re/gta5/doc/enums/eEventType.txt
 *
 * Hash: 0x7FD8F3BE76F89422 | Since: unknown | API-Set: unknown
 */
