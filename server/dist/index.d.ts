 ...
 */
export declare function canPlayerStartCommerceSession(): [boolean, string];
/**
 ...
 */
export declare function doesPlayerOwnSkuExt(skuId: number): [boolean, string];
/**
 ...
 */
export declare function doesPlayerOwnSku(skuId: number): [boolean, string];
/**
 * No comment provided
 * Hash: 0xBA0613E1 | Since: server
 */
export declare function dropPlayer(): [string, string];
/**
 * No comment provided
 ...
 */
export declare function doesPlayerExist(): [boolean, string];
/**
 * No comment provided
 ...
 */
export declare function getAirDragMultiplierForPlayersVehicle(): [number, string];
/**
 ...
 */
export declare function getNumPlayerIdentifiers(): [number, string];
/**
 * No comment provided
 ...
 */
export declare function getNumPlayerTokens(): [number, string];
/**
 * No comment provided
 ...
 */
export declare function getPlayerInvincible(): [boolean, string];
/**
 ...
 */
export declare function getPasswordHash(): [string, string];
/**
 * No comment provided
 ...
 */
export declare function getPlayerCameraRotation(): [Vector3, string];
/**
 * Gets the routing bucket for the specified player.
 * Routing buckets are also known as 'dimensions' or 'virtual worlds' in past echoes, however they are population-aware.
 * Hash: 0x52441C34 | Since: server
 */
export declare function getPlayerRoutingBucket(): [number, string];
/**
 * No comment provided
 ...
 */
export declare function getPlayerFakeWantedLevel(): [number, string];
/**
 ...
 */
export declare function getPlayerIdentifier(identiferIndex: number): [string, string];
/**
 * ```cpp
 ...
 */
export declare function getPlayerPeerStatistics(peerStatistic: number): [number, string];
/**
 ...
 */
export declare function getPlayerLastMsg(): [number, string];
/**
 * No comment provided
 * Hash: 0xE52D9680 | Since: server
 */
export declare function getPlayerGuid(): [string, string];
/**
 ...
 */
export declare function getPlayerName(): [string, string];
/**
 * No comment provided
 * Hash: 0x9873E404 | Since: server
 */
export declare function getPlayerTeam(): [number, string];
/**
 ...
 */
export declare function getPlayerFocusPos(): [Vector3, string];
/**
 * No comment provided
 ...
 */
export declare function getPlayerPed(): [number, string];
/**
 ...
 */
export declare function getPlayerIdentifierByType(): [string, string, string];
/**
 ...
 */
export declare function getPlayerPing(): [number, string];
/**
 * No comment provided
 * Hash: 0x8154E470 | Since: server
 */
export declare function getPlayerMaxHealth(): [number, string];
/**
 * No comment provided
 * Hash: 0x2A50657 | Since: server
 */
export declare function getPlayerMaxArmour(): [number, string];
/**
 * Gets the current time online for a specified player.
 * Hash: 0x67D2E605 | Since: server
 */
export declare function getPlayerTimeOnline(): [number, string];
/**
 ...
 */
export declare function getPlayerTimeInPursuit(lastPursuit: boolean): [number, string];
/**
 * No comment provided
 * Hash: 0xFEE404F9 | Since: server
 */
export declare function getPlayerEndpoint(): [string, string];
/**
 ...
 */
export declare function getPlayerWantedCentrePosition(): [Vector3, string];
/**
 * Gets a player's token. Tokens can be used to enhance banning logic, however are specific to a server.
 * Hash: 0x54C06897 | Since: server
 */
export declare function getPlayerToken(index: number): [string, string];
/**
 ...
 */
export declare function getPlayerWantedLevel(): [number, string];
/**
 * No comment provided
 ...
 */
export declare function getResourcePath(): [string, string];
/**
 * No comment provided
 ...
 */
export declare function isPlayerCommerceInfoLoadedExt(): [boolean, string];
/**
 * No comment provided
 ...
 */
export declare function isPlayerAceAllowed(): [boolean, string, string];
/**
 * No comment provided
 * Hash: 0xC7D2C20C | Since: server
 */
export declare function isPlayerUsingSuperJump(): [boolean, string];
/**
 * No comment provided
 ...
 */
export declare function loadPlayerCommerceDataExt(): string;
/**
 * No comment provided
 ...
 */
export declare function isPlayerInFreeCamMode(): [boolean, string];
/**
 ...
 */
export declare function loadPlayerCommerceData(): string;
/**
 * No comment provided
 ...
 */
export declare function isPlayerEvadingWantedLevel(): [boolean, string];
/**
 * No comment provided
 ...
 */
export declare function networkGetVoiceProximityOverrideForPlayer(): [Vector3, string];
/**
 * No comment provided
 ...
 */
export declare function performHttpRequestInternal(requestDataLength: number): [number, string];
/**
 * Requests whether or not the commerce data for the specified player has loaded.
 * Hash: 0xBEFE93F4 | Since: server
 */
export declare function isPlayerCommerceInfoLoaded(): [boolean, string];
/**
 ...
 */
export declare function registerResourceBuildTaskFactory(factoryFn: Function): string;
/**
 ...
 */
export declare function requestPlayerCommerceSession(skuId: number): string;
/**
 * No comment provided
 * Hash: 0x9338D547 | Since: server
 */
export declare function setConvarServerInfo(): [string, string];
/**
 * Writes the specified data to a file in the specified resource.
 * Using a length of `-1` will automatically detect the length assuming the data is a C string.
 * Hash: 0xA09E7E7B | Since: server
 */
export declare function saveResourceFile(dataLength: number): [boolean, string, string, string];
/**
 ...
 */
export declare function registerResourceAsset(): [string, string, string];
/**
 * **Experimental**: This native may be altered or removed in future versions of CitizenFX without warning.
 ...
 */
export declare function setConvar(): [string, string];
/**
 ...
 */
export declare function setConvarReplicated(): [string, string];
/**
 ...
 */
export declare function scheduleResourceTick(): string;
/**
 * ```cpp
 ...
 */
export declare function setGameType(): string;
/**
 ...
 */
export declare function setMapName(): string;
/**
 ...
 */
export declare function setRoutingBucketEntityLockdownMode(bucketId: number): string;
/**
 ...
 */
export declare function setPlayerCullingRadius(radius: number): string;
/**
 ...
 */
export declare function setPlayerRoutingBucket(bucket: number): string;
/**
 ...
 */
export declare function startResource(): [boolean, string];
/**
 * No comment provided
 * Hash: 0x21783161 | Since: server
 */
export declare function stopResource(): [boolean, string];
/**
 * No comment provided
 * Hash: 0x1E35DBBA | Since: server
 */
export declare function tempBanPlayer(): [string, string];
/**
 * The backing function for TriggerLatentClientEvent.
 * Hash: 0x70B35890 | Since: server
 */
export declare function triggerLatentClientEventInternal(payloadLength: number, bps: number): [string, string, string];
/**
 * No comment provided
 ...
 */
export declare function triggerClientEventInternal(payloadLength: number): [string, string, string];
/**
 ...
 */
export declare function scanResourceRoot(callback: Function): string;
/**
 ...
 */
export declare function printStructuredTrace(): string;
/**
 * No comment provided
 ...
 */
export declare function createVehicleServerSetter(modelHash: number | string, pos: Vector3, heading: number): [number, string];
/**
 * No comment provided
 ...
 */
export declare function verifyPasswordHash(): [boolean, string, string];
/**
 ...
 */
export declare function setEntityCoords(entity: number | Entity, pos: Vector3, alive: boolean, deadFlag: boolean, ragdollFlag: boolean, clearArea: boolean): void;
/**
 ...
 */
export declare function setVehicleNumberPlateText(vehicle: number | Vehicle): string;
/**
